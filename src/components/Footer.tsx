...
const Footer: React.FC = () => {
  return (
    <footer className="max-w-6xl mx-auto backdrop-blur-lg bg-purple-900/10 rounded-3xl p-8 shadow-xl border border-purple-200/10 mt-12">
      ...
      <div className="mt-8 pt-8 border-t border-purple-200/10 text-center text-purple-100/60">
        © 2024 Wagmi Grants. All rights reserved.
      </div>
    </footer>
  );
};
